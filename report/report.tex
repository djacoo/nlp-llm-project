...
weights now produce much better predictions because the model
...
\midrule
\multirow{2}{*}{2 - LoRA}
  & GPT-2 + LoRA          & 126\,M & 1.62\,M\,(1.29\%) & 70.7\% & 422 & 599.2 \\
  & DistilGPT-2 + LoRA    & 83\,M  & 0.81\,M\,(0.98\%) & 70.4\% & 246 & 409.5 \\
\midrule
3 - Classifier
  & DistilBERT            & 67\,M  & 67\,M\,(100\%) & 76.6\% & 18  & 585.5 \\
\bottomrule
\end{tabular}}

\vspace{4pt}
{\footnotesize Agent~1 models ran on CPU only (no GPU memory tracked).}
\end{table}
...
We tested four prompt variants on both frozen models. The
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{LoRA is highly effective.} Training just
        ${\sim}1\%$ of parameters yields +42 to +48 percentage point
        accuracy gains, making it a practical option when compute
        is limited.
